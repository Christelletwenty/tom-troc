...
if(isset($_POST['contenu']) && isset($_POST['created_at']) && isset($_POST['user_id']) && isset($_POST['livre_id'])) {
...
} else if(isset($_POST['contenu']) || isset($_POST['created_at']) || isset($_POST['user_id']) || isset($_POST['livre_id'])) {
