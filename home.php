...
<div class="container">
    ...
    <button onclick="location.href='index.php?page=books'">Voir tous les livres</button>
</div>
...
<div class="container grey">
    ...
    <button onclick="location.href='index.php?page=books'" class="variant">Voir tous les livres</button>
</div>
